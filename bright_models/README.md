...
>DONE = LLM based generation, 4 step pipeline profile generation -> document generation -> span resolution -> clinical coherence check and other quality checks => generated_data/data/generated_dataset.jsonl
> plus, added 600 documents with variations (typos, more variety)
> => generated_data/data/generated_dataset_extended.jsonl
